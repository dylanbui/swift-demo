...
//  PropzySam
//
//  Created by Dylan Bui on 5/17/19.
...
@IBDesignable
open class DbTextView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = DbTextView.Constants.defaultiOSPlaceholderColor {
        didSet {
