...
//  Base on : https://github.com/markcdb/RealmManager
...
extension DbRealmManager {
    ...
    fileprivate class func addOrUpdateWithRealm<T>(realm: Realm, model: String, object: T, completionHandler:@escaping(_ error: Error?) -> Void) {
        ...
        if let objE = object as? Object {
            ...
            //write func
            error = DbRealmManager.write(rlmObject: realm, writeBlock: {
            ...
            if arrE is [Object] {
                ...
                for obj in arrE {
                    ...
                    DbRealmManager.addOrUpdateWithRealm(realm: realm, model: model, object: obj, completionHandler: completionHandler)
                }
            }
